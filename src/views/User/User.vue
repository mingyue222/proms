<template>
  ...
  width="50%">
  <el-form :model="editForm" :rules="editFormRules" ref="ruleForm" label-width="80px" @close='clearEditForm'>
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="aditDialogVisible = false">确 定</el-button>
  </span>
</el-dialog>
  </div>
</template>
